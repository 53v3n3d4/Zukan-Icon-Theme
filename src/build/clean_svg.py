...
class CleanSVG:
    ...
    def clean_svg(self, svgfile: str, replace_list: Set):
        """
                ...
                with open(svgfile, 'r+') as f:
                    ...
                    for line in replace_list:
                        if line in clean_file:
                            ...
                            clean_file = self.replace_line(clean_file, line)
                            print_message(
                                basename_svgfile,
                    ...
                    clean_file = self.edit_svg_id(clean_file, basename_svgfile)
    ...
    def clean_all_svgs(self, dir_svg: str, replace_list: Set):
        """
        ...
        try:
            ...
            for svg in svgs_in_dir:
                ...
                self.clean_svg(svg, replace_list)
                # print(svg)
            # print(svgs_in_dir)
            return svgs_in_dir
        except FileNotFoundError:
    ...
    def edit_svg_id(self, clean_file: str, basename_svgfile: str):
        """
    ...
    def replace_line(self, file_info: str, line: str) -> str:
        """
