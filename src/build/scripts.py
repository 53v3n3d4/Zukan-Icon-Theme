...
def main():
    ...
    # Icon Theme
        ...
        if args.all and not (args.file or args.data):
            ...
            zukan_icon_png.svg_to_png_all(
                DATA_PATH, args.icon, args.png, args.pngprimary
            )
            ...
            zukan_icon_png.svg_to_png(args.file, args.icon, args.png, args.pngprimary)
    ...
    # Tests icons themes
        ...
        if args.all and not (args.file or args.data):
            ...
            test_icon_theme.create_icons_files(DATA_PATH, args.testspath)
        elif args.file and not (args.all or args.data):
            print_build_message('🛠️  Creating icon test file: ', args.testspath)
            test_icon_theme.create_icon_file(args.file, args.testspath)
        elif args.data and not (args.all or args.file):
            print_build_message('🛠️  Creating all icons tests files: ', args.testspath)
            test_icon_theme.create_icons_files(args.data, args.testspath)
        else:
            _error_message()
    # Zukan icons
