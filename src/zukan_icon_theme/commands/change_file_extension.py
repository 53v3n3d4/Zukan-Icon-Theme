...
#         self, edit, change_file_extension_scope: str, change_file_extension_exts: str
#     ):
#         handler = ChangeFileExtension(
#             change_file_extension_scope, change_file_extension_exts
#         )

#         if handler.validate_input():
#             handler.update_file_extensions()
...
#     def __init__(self, scope: str, extensions: str):
#         self.scope = scope
#         self.extensions = extensions
#         self.change_icon, self.change_icon_file_extension = get_change_icon_settings()
#         self.new_scopes_list = []

#     def validate_input(self):
#         if not self.scope or not self.extensions:
#             dialog_message = 'Scope and file extension inputs are required'
#             sublime.error_message(dialog_message)
#             return False
#         return True
...
#         # Convert change_file_extension_exts to list
#         list_change_file_extension_exts = [
#             s.strip() for s in self.extensions.split(',')
#         ]
#         inserted_scope_file_extension = {
#             'scope': self.scope,
#             'file_extensions': list_change_file_extension_exts,
...
#         if self.change_icon_file_extension:
#             self._update_change_file_extensions(
#                 inserted_scope_file_extension, list_change_file_extension_exts
#             )
#         else:
#             # change_icon_file_extension empty
#             self._empty_change_file_extension(inserted_scope_file_extension)

#     def _update_change_file_extensions(
#         self, inserted_scope_file_extension, list_change_file_extension_exts
#     ):
#         for d in self.change_icon_file_extension:
#             # print(change_icon_file_extension)
#             list_extesnions_difference = list(
#                 set(list_change_file_extension_exts).difference(d['file_extensions'])
#             )

#             # Scope does not exist in change_icon_file_extension
#             if (
#                 not any(
#                     d['scope'] == self.scope for d in self.change_icon_file_extension
#                 )
#                 and self.scope != d['scope']
#             ):
#                 logger.debug(
#                     '%s scope does not exist in change_icon_file_extension',
#                     self.scope,
...
#                 self.new_scopes_list.append(inserted_scope_file_extension)
#                 # print(new_scopes_list)

#             # Scope exists in change_icon_file_extension
#             # Add if file extension does not exist
#             if (
#                 any(d['scope'] == self.scope for d in self.change_icon_file_extension)
#                 and self.scope == d['scope']
#             ):
#                 if list_extesnions_difference:
#                     logger.debug(
...
#             self._file_extension_exists(d, list_change_file_extension_exts)

#     def _file_extension_exists(self, d, list_change_file_extension_exts):
#         # File extension exist
#         if self.scope != d['scope'] and not set(
#             list_change_file_extension_exts
#         ).isdisjoint(set(d['file_extensions'])):
#             dialog_message = 'File extension present in different scope'
#             sublime.error_message(dialog_message)
...
#     def _empty_change_file_extension(self, inserted_scope_file_extension):
#         logger.debug('change_icon_file_extension is empty')
#         self.change_icon_file_extension.append(inserted_scope_file_extension)

#     def save_settings(self):
#         # Cleaning duplicated
#         file_extensions_list_not_duplicated = [
#             f
#             for i, f in enumerate(self.new_scopes_list)
#             if self.new_scopes_list.index(f) == i
#         ]

#         set_save_settings(
#             ZUKAN_SETTINGS,
#             'change_icon_file_extension',
#             self.change_icon_file_extension + file_extensions_list_not_duplicated,
#         )
...
#     def placeholder(self):
#         sublime.status_message('Icon syntaxes files in "icons_syntaxes" folder')
#         return 'Type file extensions, separated by comma. E.g. js, cjs, mjs'
...
#     def run(self, edit, scope_name: str):
#         handler = ResetFileExtension(scope_name)

#         handler.reset_file_extensions()
#         handler.save_settings()
...
# class ResetFileExtension:
#     def __init__(self, scope_name: str):
#         self.scope_name = scope_name
#         self.change_icon, self.change_icon_file_extension = get_change_icon_settings()
#         self.zukan_listener_enabled = is_zukan_listener_enabled()

#     def reset_file_extensions(self):
#         if self.scope_name == 'All':
#             self.reset_all_scopes()
#         else:
#             self.reset_scope()

#     def reset_all_scopes(self):
#         self.change_icon_file_extension_updated = []
...
#         self.change_icon_file_extension_updated = [
#             i for i in self.change_icon_file_extension if i['scope'] != self.scope_name
#         ]

#         if self.zukan_listener_enabled:
#             logger.info('reseting file extensions for %s', self.scope_name)
