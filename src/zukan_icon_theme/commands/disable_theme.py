...
# class DisableTheme:
#     def __init__(self, theme_st_path: str):
#         self.theme_name = os.path.basename(theme_st_path)
#         self.ignored_theme, _ = get_theme_settings()

#     def disable(self):
#         if self.theme_name not in self.ignored_theme:
#             self._add_to_ignored_themes()
#             self._save_ignored_themes()

#     def _add_to_ignored_themes(self):
#         self.ignored_theme.append(self.theme_name)

#     def _save_ignored_themes(self):
#         sort_list = sorted(self.ignored_theme)
#         set_save_settings(ZUKAN_SETTINGS, 'ignored_theme', sort_list)

#         logger.info('%s ignored', self.theme_name)
...
#     def run(self, edit, theme_st_path: str):
#         disable_theme = DisableTheme(theme_st_path)
#         disable_theme.disable()
...
#     def enable(self):
#         if self.ignored_theme:
#             if self.theme_name == 'All':
#                 self._enable_all_icons_themes()
#             else:
#                 self._enable_icon_theme()

#             self._save_ignored_themes()

#     def _enable_icon_theme(self):
#         # Remove theme_name
#         self.ignored_theme = [t for t in self.ignored_theme if not t == self.theme_name]

#         if self.zukan_listener_enabled:
#             logger.info('enabling %s', self.theme_name)

#     def _enable_all_icons_themes(self):
#         self.ignored_theme = []
...
#     def run(self, edit, theme_name: str):
#         enable_theme = EnableTheme(theme_name)
#         enable_theme.enable()
