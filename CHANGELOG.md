...
- Add icon-theme: ActionScript, Ada, Ansible, AppleScript, archive, AsciiDoc, ASP, Astro, Avro, Azure, Babashka, Batch File, Bazel, Behat, BibTeX, Biome, Bitbucket, Cabal, Caddyserver, Cairo, Cap'n Proto, Cargo, Cassandra, Cert, Clojure, ClojureDart, ClojureScript, Codacy, commitlint, Composer, Conan, Conda, Crystal, CUDA, Cypress, D, Deno, Dart, Diff, Dioxus, Django, Drone, DUB, EditorConfig, Eleventy, Erlang.mk, F#, Figma, Firebase, Fish, Flask, Flow, Flutter, Font, Fortran, GitBook, git-cliff, GitHub, GitLab, Gitpod, Gleam, GolangCI-Lint, Gradle, Graphviz (DOT), Groovy, glTF, Haml, Handlebars, Haskell, Hex, Hugo, isort, Istanbul, Jasmine, Julia, Jinja, Jupyter, Knip, Kong, LaTeX, Lavarel, Lerna, Liquid, Lisp, MATLAB, Maven, Mermaid, Meson, MkDocs, Mocha, mypy, MySQL, NAnt, Nest, Nim, Nitro, Nix, NSIS, NuGet, NumPy, Nushell, Nuxt, Nx, OCaml, PDM, Perl, PHP CS Fixer, PHPStan, PHPUnit, Pine, Pipenv, Playwright, Plist, PLSQL, PostCSS, PostgreSQL, pre-commit, Prisma, Pug, Pylint, Pyre, Pyright, Qt, R, Read the Docs, Rebar3, Redis, Regular Expression, Renovate, reStructuredText, Rspec, RuboCop, RVM, sbt, Scala, Scala Steward, Scalafix, Scalameta, Sentry, Smarty, Solidity, SQLite, Stylelint, SVGO, Swagger, Symfony, SystemVerilog Tailwind CSS, Tauri, Tcl, TeX, Textile, Terraform, tmux, Toit, tox, Twig, Typst, uv, Vercel, Vyper, Yaws, Yugabyte, Zig
