...
- Add icon-theme: archive, Avro, Babashka, BibTeX, Cabal, Cargo, Clojure, ClojureDart, ClojureScript, Cypress, Erlang.mk, Gradle, Groovy, glTF, Haml, Haskell, Jupyter, LaTeX, Lisp, mypy, Pipenv, Playwright, pre-commit, Pylint, Pyright, Read the Docs, Rebar3, reStructuredText, Rspec, RVM, sbt, Scala, Tailwind CSS, TeX, tox
