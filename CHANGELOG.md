...
- Add icon-theme: archive, Avro, BibTeX, Cargo, Cypress, Erlang.mk, glTF, Haml, Jupyter, LaTeX, mypy, Pipenv, Playwright, pre-commit, Pylint, Pyright, Read the Docs, Rebar3, reStructuredText, Rspec, RVM, Tailwind CSS, TeX, tox
