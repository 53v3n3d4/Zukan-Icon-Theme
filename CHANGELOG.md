...
- Add icon-theme: archive, AsciiDoc, Avro, Babashka, BibTeX, Cabal, Cargo, Clojure, ClojureDart, ClojureScript, Cypress, Django, Erlang.mk, Fortran, GitBook Gradle, Groovy, glTF, Haml, Haskell, Jinja, Jupyter, LaTeX, Lisp, mypy, Pipenv, Playwright, pre-commit, Pylint, Pyright, Read the Docs, Rebar3, reStructuredText, Rspec, RVM, sbt, Scala, Tailwind CSS, TeX, tox, Yaws
