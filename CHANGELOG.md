## [0.1.1] - 2023
- Add alias: go, typescript
- Add file type icons: makefile, webassembly, afphoto, afpub
- Change alias: ruby
- Change file type icon: settings, toml, afdesign
- Change preferences: typescript
