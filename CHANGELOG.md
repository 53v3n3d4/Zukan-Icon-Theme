...
- Add icon-theme: archive, AsciiDoc, Avro, Babashka, BibTeX, Cabal, Cap'n Proto, Cargo, Clojure, ClojureDart, ClojureScript, Cypress, Django, Erlang.mk, Fortran, GitBook Gradle, Groovy, glTF, Haml, Handlebars, Haskell, isort, Jinja, Jupyter, LaTeX, Lisp, mypy, OCaml, Pipenv, Playwright, Plist, pre-commit, Pylint, Pyright, Read the Docs, Rebar3, reStructuredText, Rspec, RuboCop, RVM, sbt, Scala, Tailwind CSS, TeX, tox, Yaws
