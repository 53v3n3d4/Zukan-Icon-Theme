...
```json
    "change_icon_file_extension": [
        ...
        { "scope": "source.json.sublimemerge", "file_extensions": ["Preferences.sublime-settings"] },
        ...
        { "scope": "source.toml.cargo", "file_extensions": ["config.toml"] },
        ...
        { "scope": "source.toml.pip", "file_extensions": ["pylock.toml"] },
        { "scope": "source.toml.uv", "file_extensions": ["pylock.toml"] },
        ...
        { "scope": "source.yaml", "file_extensions": ["Chart.yaml"] },
        { "scope": "source.yaml", "file_extensions": ["config.yml"] },
        { "scope": "source.yaml", "file_extensions": ["kong.yml"] },
        { "scope": "source.yaml", "file_extensions": ["values.yaml"] },
