...
DATA_PATH = os.path.normpath(zukan_paths.filepath('../../data'))
...
params_list = [
    (os.path.join(zukan_paths.PACKAGES_PATH), ST_PACKAGES_PATH),
    (os.path.join(zukan_paths.INSTALLED_PACKAGES_PATH), ST_INSTALLED_PACKAGES_PATH),
    (
        zukan_paths.ZUKAN_PKG_ICONS_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME, 'icons'),
    ),
    (
        zukan_paths.ZUKAN_PKG_ICONS_PREFERENCES_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME, 'icons_preferences'),
    ),
    (
        zukan_paths.ZUKAN_PKG_ICONS_SYNTAXES_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME, 'icons_syntaxes'),
    ),
    (
        zukan_paths.ZUKAN_PKG_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME),
    ),
    (
        zukan_paths.ZUKAN_PKG_SRC_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME, 'src'),
    ),
    (
        zukan_paths.ZUKAN_PKG_SUBLIME_PATH,
        os.path.join(ST_PACKAGES_PATH, PACKAGE_NAME, 'sublime'),
    ),
    (
        zukan_paths.ZUKAN_INSTALLED_PKG_PATH,
        os.path.join(
            ST_INSTALLED_PACKAGES_PATH,
            PACKAGE_NAME + file_extensions.SUBLIME_PACKAGE_EXTENSION,
        ),
    ),
    (
        ...
        os.path.join(
            ...
            PACKAGE_NAME,
            'icons_data',
            'zukan_icons_data' + file_extensions.PICKLE_EXTENSION,
        ),
    ),
    (
        ...
        os.path.join(
            ...
            PACKAGE_NAME,
            'sublime',
            'zukan-version' + file_extensions.SUBLIME_SETTINGS_EXTENSION,
        ),
    ),
    (
        ...
        os.path.join(
            ...
            PACKAGE_NAME,
            'sublime',
            'zukan_current_settings' + file_extensions.PICKLE_EXTENSION,
        ),
    ),
]
...
class TestZukanPaths(TestCase):
    def test_param_is_string(self):
        TESTS_FOLDER = os.path.normpath(zukan_paths.filepath('../tests'))
    ...
    def test_relative_path(self):
        ...
        TESTS_RELATIVE_PATH = os.path.normpath('../zukan_icon_theme/tests')
